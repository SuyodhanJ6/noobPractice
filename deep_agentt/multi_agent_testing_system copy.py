...
def create_multi_agent_system():
    """
    Create the complete multi-agent system using deepagents structure.
    
    Returns a configuration for creating a deep agent with 3 sub-agents.
    """
    from deepagents import create_deep_agent
    
    # Create models for each agent using init_chat_model
    # Format: "provider:model" - init_chat_model handles provider detection
    ...
    subagents = [
        {
            ...
            "description": "Generates end-to-end test scenarios based on user journeys and critical paths",
        ...
        },
        {
            ...
            "description": "Generates integration test scenarios for APIs, databases, and service interactions",
        ...
        },
        {
            ...
            "description": "Generates functional test scenarios for features, edge cases, and error handling",
    ...
    agent = create_deep_agent(
        ...
        tools=[],  # Main agent uses sub-agents, not direct tools
        subagents=subagents,
    )
...
def run_fallback_multi_agent_system(user_story: str, project_context: str, complexity: str):
    ...
    This works without deepagents infrastructure.
    """
    from langchain_core.messages import SystemMessage, HumanMessage
